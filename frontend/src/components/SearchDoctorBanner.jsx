    ...
    return (
        <div className="bg-[#08376B]">
            <div className="w-full mx-auto space-y-5 py-18 text-center">
                ...
                <Link to="/search" className="px-8 py-3 bg-[#00B092] text-sm text-white rounded-md">Search Your Doctor</Link>
            </div>
        </div>
    );
};

export default SearchDoctorBanner;