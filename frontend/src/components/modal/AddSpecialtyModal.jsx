...
const AddSpecialtyModal = ({onClose}) => {
    ...
    const handleSpecialtySubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const result = await createSpecialties(data);
    ...
    return (
        <div
            className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-xs backdrop-brightness-90 px-4 sm:px-6 py-10 overflow-y-auto">
