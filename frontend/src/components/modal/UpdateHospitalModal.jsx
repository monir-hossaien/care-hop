...
const UpdateHospitalModal = ({hospital, onClose}) => {
    ...
    const {fetchHospitalDetails, updateHospital, fetchAllHospitalList, formData, inputOnChange, resetFormData} = hospitalStore()
    const {_id} = hospital
    ...
    useEffect(()=>{
        (async ()=>{
            ...
            await fetchHospitalDetails(_id)
        })()
    }, [_id])
    ...
    const handleUpdateHospital = async (e) => {
        ...
        try {
            setLoading(true);
            const result = await updateHospital(_id, data);
